...
const fetchData = () => {
    fetch(`${BASE_URL}/api/buildings/type/House`)
      .then(res => res.json())
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.bottomTab}>
          <TouchableOpacity style={styles.inactiveBottom} onPress={() => navigation.navigate('Apart')}>
            <Text style={styles.inactiveBottomText}>Apart</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.activeBottom}>
            <Text style={styles.activeBottomText}>House</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
